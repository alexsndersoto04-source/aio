...
Collections remain explicitly unsupported. Additional asynchronous APIs (streaming request bodies), source maps, richer typed event objects, WebGL bindings, and eventually managed heap reclamation are subsequent Phase 6 blocks.
