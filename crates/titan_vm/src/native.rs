...
fn dispatch(name: &str, mut args: Vec<Value>) -> Result<Value, String> {
    ...
    Ok(match name {
        ...
        "std::web::query_exists" | "std::web::set_text" | "std::web::set_html" | "std::web::set_attribute" | "std::web::add_class" | "std::web::remove_class" | "std::web::focus" | "std::web::set_title" | "std::web::listen" | "std::web::unlisten" | "std::web::event_type" | "std::web::event_value" | "std::web::event_key" | "std::web::event_target_id" | "std::web::event_checked" | "std::web::event_x" | "std::web::event_y" => return Err("std::web functions require the WebAssembly browser host".into()),
