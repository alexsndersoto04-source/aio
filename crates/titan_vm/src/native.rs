...
fn dispatch(name: &str, mut args: Vec<Value>) -> Result<Value, String> {
    ...
    Ok(match name {
        ...
        "std::wasm::heap_used" | "std::wasm::heap_capacity" | "std::wasm::heap_limit" | "std::wasm::heap_set_limit" | "std::wasm::heap_checkpoint" | "std::wasm::heap_restore" | "std::wasm::heap_allocations" | "std::wasm::heap_allocated_bytes" | "std::wasm::heap_restores" | "std::wasm::heap_reclaimed_bytes" | "std::wasm::heap_peak_used" | "std::wasm::heap_reset_counters" => return Err("std::wasm heap functions require the WebAssembly backend".into()),
