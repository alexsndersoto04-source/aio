...
fn dispatch(name: &str, mut args: Vec<Value>) -> Result<Value, String> {
    ...
    Ok(match name {
        ...
        "std::web::query_exists" | "std::web::set_text" | "std::web::set_html" | "std::web::set_attribute" | "std::web::add_class" | "std::web::remove_class" | "std::web::focus" | "std::web::set_title" => return Err("std::web functions require the WebAssembly browser host".into()),
