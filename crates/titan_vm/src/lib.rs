...
pub enum Value {
    ...
    TcpListener(u64), TcpStream(u64), HttpRouter(u64), TlsStream(u64), TlsServerConfig(u64), WebSocketDecoder(u64), WebSocket(u64), ServerControl(u64), Sqlite(u64), SqlitePool(u64), Postgres(u64), PostgresPool(u64), Mysql(u64),
}
