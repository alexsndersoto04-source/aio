...
#[derive(Error, Debug, Clone, PartialEq, Eq)] pub enum WebSocketError {
    ...
    #[error("invalid WebSocket URL")] InvalidUrl,
    #[error("invalid WebSocket server handshake")] InvalidHandshake,
}
