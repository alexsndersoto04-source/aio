...
pub static NATIVES: &[NativeSignature] = &[
    ...
    native!("std::text::parse_int", [String], Option),
    native!("std::text::parse_float", [String], Option),
    ...
    native!("std::ws::parse", [Bytes, Bool, Int], Option),
    ...
    // Fase 41 — base del reproductor de música: metadatos, biblioteca y
    // motor de reproducción sobre reproductores del sistema.
    native!("std::audio::tags", [String], Map),
    native!("std::audio::duration", [String], Float),
    native!("std::audio::scan_library", [String], Array),
    native!("std::audio::player_play", [String], String),
    native!("std::audio::player_stop", [], String),
    native!("std::audio::player_pause", [], String),
    native!("std::audio::player_resume", [], String),
    native!("std::audio::player_position", [], Float),
    native!("std::audio::player_set_volume", [Int], Bool),
    native!("std::audio::player_seek", [Float], String),
    ...
    // Fase 43 — nube musical en Telegram (streaming puro).
    native!("std::audio::cloud_setup", [Int, String], String),
    native!("std::audio::cloud_login_phone", [String], String),
    native!("std::audio::cloud_login_code", [String], String),
    native!("std::audio::cloud_login_password", [String], String),
    native!("std::audio::cloud_status", [], Map),
    native!("std::audio::cloud_logout", [], String),
    native!("std::audio::cloud_library", [], Array),
    native!("std::audio::cloud_upload", [String], String),
    native!("std::audio::cloud_download", [Int, String], String),
    native!("std::audio::cloud_delete", [Int], String),
    native!("std::audio::cloud_queue_add", [Int], String),
    native!("std::audio::cloud_play", [Int], String),
    ...
    native!("std::process::spawn_poll", [Int], Option, Process),
    native!("std::process::spawn_kill", [Int], Nil, Process),
    native!("std::process::spawn_pid", [Int], Int, Process),
    native!("std::process::env_get", [String], Option, Environment),
    ...
    native!("std::collections::deque_pop_front", [Int], Option),
    native!("std::collections::deque_pop_back", [Int], Option),
    ...
    native!("std::collections::pq_pop", [Int], Option),
    native!("std::collections::pq_peek", [Int], Option),
    ...
    native!("std::collections::omap_get", [Int, String], Option),
