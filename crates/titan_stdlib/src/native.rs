...
pub static NATIVES: &[NativeSignature] = &[
    ...
    native!("std::metrics::histogram_record", [String, Float], Nil), native!("std::metrics::snapshot", [], Map),
    native!("std::metrics::prometheus_export", [], String), native!("std::metrics::reset", [], Nil),
    ...
    // Phase 41: real clipboard / notifications (subprocesses to native CLIs).
    native!("std::clipboard::get_text", [], String, Process),
    native!("std::clipboard::set_text", [String], Bool, Process),
    native!("std::notify::send", [String, String], Bool, Process),
    ...
    native!("std::process::run_with_input",   [String, Bytes], Map, Process),
    ...
    native!("std::collections::graph_add_edge",      [Int, String, String, Int], Nil),
    ...
    native!("std::collections::graph_shortest_path", [Int, String, String], Array),
    ...
    native!("std::datetime::from_ymd_hms",  [Int, Int, Int, Int, Int, Int], Int),
