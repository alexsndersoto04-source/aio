...
const casos = [
  ...
  ['GET', '/api/users/presence', null, (d) => Array.isArray(d.en_linea) && typeof d.total_en_linea === 'number'],
  ['GET', '/api/me/stats', null, (d) => typeof d.posts === 'number' && typeof d.me_gusta_recibidos === 'number'],
  ['GET', '/api/me/blocked', null, esLista],
  ['GET', '/api/notifications/prefs', null, (d) => d.follow === true && typeof d.like === 'boolean'],
  ['PATCH', '/api/notifications/prefs', { like: false }, (d) => d.like === false],
  ['GET', '/api/posts/101/likes', null, (d) => typeof d.total === 'number' && esLista(d.items)],
  ['GET', '/api/health', null, (d) => d.status === 'ok' && typeof d.db === 'boolean'],
  ['POST', '/api/posts/108/vote', { opcion: 0 }, (d) => d.poll && d.poll.mi_voto.includes(0) && d.poll.total > 0],
  ['GET', '/api/push/public-key', null, (d) => !!d.key],
  ['GET', '/api/push/estado', null, (d) => typeof d.dispositivos === 'number'],
  ['POST', '/api/push/test', {}, (d) => d.ok === true],
  ['POST', '/api/push/subscribe', { endpoint: 'e', keys: { p256dh: 'p', auth: 'a' } }, (d) => d.ok === true],
  ['DELETE', '/api/push/subscribe', { endpoint: 'e' }, (d) => d.ok === true],
  ['GET', '/api/admin/backup', null, (d) => !!d.resumen],
